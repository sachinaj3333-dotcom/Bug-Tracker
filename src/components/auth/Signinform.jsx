...
import signInHelper from '../../helper/auth/sign-in-helper';
// import Signup from "../../pages/auth/Signup.jsx";

const SigninForm = () => {

    const {handleChange, handleSubmit, errors, formValue} = signInHelper();
        ...
        <>
            ...
            <form className="row g-3" onSubmit={handleSubmit}>
                ...
                <div className="col-md-12 mb-3">
                    ...
                    <input type="password" className={`form-control ${Styles.input_area}`} onChange={handleChange} value={formValue.userPass} name='userPass' placeholder='Enter yourpassword' />
                    {errors.userPass && (
