    ...
    <>
      ...
      <form className="row g-3">
        <div className="col-md-12">
          ...
          <input type="text" className={`form-control ${Styles.input_area}`} name='userName' placeholder='Enter your Name' />
        </div>
        <div className="col-md-12">
          ...
          <input type="email" className={`form-control ${Styles.input_area}`} name='userEmail' placeholder='Enter your email' />
        </div>
        <div className="col-6">
          ...
          <input type="password" className={`form-control ${Styles.input_area}`} name='userPass' placeholder='Create a password' />
        </div>
        <div className="col-6">
          ...
          <input type="password" className={`form-control ${Styles.input_area}`} name='confirmPass' placeholder="Confirm your password" />
        </div>
