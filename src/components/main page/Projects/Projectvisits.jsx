                        ...
                        <div className={`row g-0`}>
                            <div className="col-5 pt-3">
                                <span className={`${Styles.project_logo}`}>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" className="bi bi-folder2-open" viewBox="0 0 16 16">
                        ...
                        <div className={`row g-0`}>
                            <div className="col-5 pt-3">
                                <span className={`${Styles.on_hold_logo}`}>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" className="bi bi-pause-circle" viewBox="0 0 16 16">
                                        <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14m0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16" />
